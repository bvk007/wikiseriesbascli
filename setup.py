...
setup(
    name='''wikiseriesbascli''',
    version=version,
    description='''A cli to represent output from wiki series lib''',
    long_description=readme + '\n\n' + history,
    author='''Bas van Kesteren''',
    author_email='''bvkdummy@gmail.com''',
    url='''https://github.com/bvk007/wikiseriesbascli''',
    packages=find_packages(where='.', exclude=('tests', 'hooks', '_CI*')),
    package_dir={'''wikiseriesbascli''':
                 '''wikiseriesbascli'''},
    include_package_data=True,
    install_requires=requirements,
    license='MIT',
    zip_safe=False,
    keywords='''wikiseriesbascli ''',
    entry_points = {
                   'console_scripts': [
